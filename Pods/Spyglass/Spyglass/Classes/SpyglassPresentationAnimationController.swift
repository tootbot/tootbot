...
public class SpyglassPresentationAnimationController: NSObject, SpyglassAnimationController {
    ...
    public let transitionType = SpyglassTransitionType.presentation
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        animator.perform(animations: {
            ...
            if let destinationRect = snapshotDestinationRect {
