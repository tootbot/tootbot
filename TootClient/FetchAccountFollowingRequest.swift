...
public struct FetchAccountFollowingRequest: Request {
    ...
    public func build() -> URLRequest {
        var request = URLRequest(url: userAccount.instanceURL.appendingPathComponent("api/v1/accounts/\(accountID)/following"))
